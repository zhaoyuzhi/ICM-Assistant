...
def main(args):
    ...
    print(conv)
    prompt = ('A chat between a curious human and an artificial intelligence assistant. The assistant gives helpful, detailed, and polite answers to the human\'s questions. USER: <image> %s Answer yes or no. ASSISTANT:') % (args.question)
    print(prompt)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--question", type=str, default='Is the character in the picture sexy?')
