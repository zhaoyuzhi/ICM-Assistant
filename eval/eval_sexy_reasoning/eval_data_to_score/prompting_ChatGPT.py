...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_path', type = str, default = './eval_sexy_reasoning/eval_data_analysis/eval_sexy_reasoning_results/llava_ablation_study', help = 'File save path')
