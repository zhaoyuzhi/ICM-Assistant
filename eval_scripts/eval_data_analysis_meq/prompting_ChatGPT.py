...
if __name__ == "__main__":
    ...
    parser.add_argument('--human_txt_path', type = str, default = './eval_sexy_reasoning/eval_sexy_reasoning_data/gt_description.txt', help = 'File path')
    parser.add_argument('--algo_txt_path', type = str, default = './eval_sexy_reasoning/eval_sexy_reasoning_data/llava_ablation_study/llava-v1.5-7b-ab4-3.txt', help = 'File path')
    parser.add_argument('--save_path', type = str, default = './eval_sexy_reasoning/eval_sexy_reasoning_results/llava_ablation_study', help = 'File save path')
