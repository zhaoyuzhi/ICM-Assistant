...
if __name__ == "__main__":
    ...
    base_path = 'D:\\dataset\\advertisement_data\\ECCV_2024_data\\data\\test'
    result_file = './eval_sexy_classification_and_score/eval_sexy_classification_and_score_test_data/mllm_ablation_study/llava-v1.5-7b-after-baseline.json.json'
