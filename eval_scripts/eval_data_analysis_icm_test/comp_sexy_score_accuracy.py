...
if __name__ == "__main__":
    ...
    # define folder path
    folder_path = '../../eval_sexy_classification_and_score/eval_sexy_classification_and_score_test_data'

    # read generated lists
    data_list = [
        'mllm_ablation_study/llava-v1.5-7b-after-baseline.json',
        ...
        'raw_network/resnet50_8xb32_in1k.json',
        'raw_network/resnet152_8xb32_in1k.json',
        'raw_network/densenet201_4xb256_in1k.json',
        'raw_network/clip-vit-l-14-336.json',
